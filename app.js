...
import { View, Text, StyleSheet, TouchableOpacity, Vibration, Alert, TextInput, SafeAreaView } from 'react-native';
import { Audio } from 'expo-av';
import * as Location from 'expo-location';

const API_URL = "https://SEU_CODESPACE_URL:8000/processar_voz";

// Emoji para ícone de clima
const WEATHER_ICON = "☀️";
...
export default function App() {
  ...
  if (view === 'weather')
    return (
      <SafeAreaView style={styles.cWeather}>
        <TouchableOpacity onPress={handleSecretTrigger}>
          <Text style={{ fontSize: 80 }}>{WEATHER_ICON}</Text>
        </TouchableOpacity>
  ...
  if (view === 'password')
    return (
      <SafeAreaView style={styles.cIara}>
